...
export const ProjectList = [
  ...
  {
    name: "Prajeeth's Pizzeria",
    image: Proj2,
    skills: "Reactjs,CSS",
    github: "https://github.com/yourusername/prajeeths-pizzeria", // GitHub link
    description: "A modern pizzeria website built with React for managing menu and orders.",
  },
  {
    name: "Dynamic Pricing System",
    image: Proj3,
    skills: "Html,CSS,JavaScript,Nodejs,Mongodb",
    github: "https://github.com/yourusername/dynamic-pricing-system", // GitHub link
    description: "A system for dynamic pricing based on user demand and other factors.",
  },
  {
